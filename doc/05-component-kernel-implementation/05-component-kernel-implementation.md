...
The neural node will be made up of two Queues; one to hold the data, and one to hold the weights. Since the node's functionality can be compared to a calculator, the Queue will allow for easy access and summation of weights.
